...
# Generated: 2026-06-05T21:16:31.329Z

$ErrorActionPreference = 'Continue'
Start-Transcript -Path "D:\\projects\\agentdock\\logs\\launch-kimi-heavy-code-2026-06-05T21-16-31-329Z.md" -Force
Write-Host 'AgentDock launching profile: Kimi Heavy Code'
Write-Host 'Profile ID: kimi-heavy-code'
Write-Host 'Started: 2026-06-05T21:16:31.329Z'
