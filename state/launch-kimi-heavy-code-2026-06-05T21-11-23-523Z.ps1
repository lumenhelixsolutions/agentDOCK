...
# Generated: 2026-06-05T21:11:23.523Z

$ErrorActionPreference = 'Continue'
Start-Transcript -Path "D:\\projects\\agentdock\\logs\\launch-kimi-heavy-code-2026-06-05T21-11-23-523Z.md" -Force
Write-Host 'AgentDock launching profile: Kimi Heavy Code'
Write-Host 'Profile ID: kimi-heavy-code'
Write-Host 'Started: 2026-06-05T21:11:23.523Z'
