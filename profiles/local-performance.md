...
task_mode: optimize
status: known-good
description: Profile and optimize performance bottlenecks. Uses local Ollama + Hermes for maximum privacy.
---
...
Write-Host "Local Performance mode — private, no data leaves this machine."
