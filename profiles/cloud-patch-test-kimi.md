---
id: cloud-patch-test-kimi
name: Cloud Patch / Test (kimi)
frontend: kimi
command: kimi
backend: moonshot
mode: full-cloud
...
required_env:
  - MOONSHOT_API_KEY
status: unknown
description: Small focused changes with test verification. Full cloud via kimi for speed and capability.
---

# Cloud Patch / Test (kimi)
