---
id: cloud-safe-audit-codex
name: Cloud Safe Audit (codex)
frontend: codex
command: codex
backend: openai
mode: full-cloud
...
required_env:
  - OPENAI_API_KEY
status: unknown
description: Read-only audit. No writes, no shell, no git push. Full cloud via codex for speed and capability.
---

# Cloud Safe Audit (codex)
