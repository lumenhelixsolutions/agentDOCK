...
task_mode: design
status: known-good
description: System design, planning, and structural decisions. Uses local Ollama + Hermes for maximum privacy.
---
...
Write-Host "Local Architecture mode — private, no data leaves this machine."
